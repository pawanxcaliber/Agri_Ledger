      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        >
          ...
          <View style={styles.textContainer}>
            ...
            <Text style={styles.cardSubtitle}>Manage transactions & media</Text>
          </View>
        </TouchableOpacity>
        ...
        >
          ...
          <View style={styles.textContainer}>
            ...
            <Text style={styles.cardSubtitle}>Check local farm forecast</Text>
          </View>
        </TouchableOpacity>
        ...
        >
          ...
          <View style={styles.textContainer}>
            ...
            <Text style={styles.cardSubtitle}>Attendance & Staff List</Text>
          </View>
        </TouchableOpacity>
